...
This repository hosts official downloads and user documentation. Bundled third-party notices accompany the Mac application. The Lil Guy artwork and Soul Buddy icon are adapted from [Lil Guy by clterryart](https://rive.app/marketplace/18912-35694-lil-guy/) under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
